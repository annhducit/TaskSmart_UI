      ...
      <>
        {isDragging && (
          <div
            ref={setNodeRef}
            style={style}
            className='relative flex h-[120px] min-h-[120px] cursor-grabbing items-start rounded-xl bg-black/50 p-2.5 text-left opacity-30 hover:ring-2 hover:ring-inset hover:ring-primary-default'
          />
        )}
      </>
      {!isDragging && (
