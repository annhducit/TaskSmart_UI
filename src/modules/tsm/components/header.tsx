...
import { Button, Divider, Input, MenuProps, Popover } from 'antd';
import {
  Bell,
  CirclePlus,
  HelpCircle,
  ...
  return (
    <header className='bg-[#2e3754] px-6 py-2 shadow'>
      <div className='flex items-center justify-between'>
        ...
        <div className='flex items-center gap-x-4'>
          <Input.Search className='w-[300px] text-base font-semibold' placeholder='Enter keyword' />
          <Button
...
const content = (
  <div className='flex flex-col gap-y-2'>
    ...
    <Button>Start with samples</Button>
  </div>
);
